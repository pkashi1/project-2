      ...
      {/* <section className="py-20 bg-primary-600 dark:bg-primary-800 text-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:careers@southernunderground.com" className="px-8 py-3 bg-secondary-500 dark:bg-secondary-600 rounded-lg font-semibold hover:bg-secondary-600 dark:hover:bg-secondary-700 transition-colors">{t('contactHR')}</a>
